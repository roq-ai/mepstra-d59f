  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Mepstra, your ultimate platform for IoT devices automation software. Discover, purchase, and experience the future of technology today."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1558346490-a72e53ae2d4f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpb3R8ZW58MHx8fHwxNjkwMTg5MDAzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Mepstra, your ultimate platform for IoT devices automation software. Discover, purchase, and experience the future of technology today.`}
            </Text>
            <Box

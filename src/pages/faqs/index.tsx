...
type ColumnType = ColumnDef<FaqInterface, unknown>;
...
export function FaqListPage(props: FaqListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<FaqInterface>>(
    () => `/faqs?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      : null,
    {
      ...
      cell: ({ row: { original: record } }: any) => (
        <Flex justifyContent="flex-end">
          <NextLink href={`/faqs/view/${record.id}`} passHref legacyBehavior>
            <Button
